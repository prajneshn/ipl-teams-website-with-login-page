...
if($conn) {
    ...
    if(mysqli_num_rows($rslt)>0){
        ...
        if($pass==$cnpass){
            $cmt="UPDATE form SET password = '$pass' WHERE Fname='$fname' AND Email = '$email'";
            $rslt=mysqli_query($conn,$cmt);
            if($rslt){
...
<body>
    <div class="main">
        ...
        <div class="box1">
            <h1 class="wlcm">Reset Your Password</h1>
            ...
            <input name="password" class="form__input2" type="password" placeholder="New Password">
            <input name="cnpassword" class="form__input2" type="text" placeholder="Conform Password">

            <button type="submit" name="button" class="button button2">RESET</button>
            </form>
        </div>
        <div class="box2">
